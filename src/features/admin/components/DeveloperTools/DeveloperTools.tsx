...
const TEST_PROJECTS: TestProjectData[] = [
  ...
  // 1. January 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Scientific yet approachable, clean modern aesthetic, DNA/helix motifs, blue-green palette (var(--color-accent), var(--color-success))',
  ...
  // 2. February 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Luxury minimalist, ocean-inspired palette (var(--color-accent-dark), var(--color-info-light)), large imagery, elegant typography',
  ...
  // 3. March 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Playful and warm, bright cheerful colors (var(--color-warning), var(--priority-high)), cute pet illustrations, friendly tone',
  ...
  // 4. April 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Modern craft aesthetic, warm earth tones (var(--color-warning-dark), var(--color-warning-light)), hand-drawn elements, vintage-modern fusion',
  ...
  // 6. June 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Vibrant and energetic, psychedelic-modern fusion, sunset color palette (var(--priority-high), var(--priority-high), var(--color-purple-500))',
  ...
  // 7. July 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Fresh and clean, appetite-appealing, green-focused palette (var(--color-success), var(--color-success-light)), quick-scan layouts',
  ...
  // 8. August 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Serene and minimal, soft gradients, nature-inspired palette (var(--color-success-light), var(--color-info-light), var(--color-warning-light)), gentle animations',
  ...
  // 9. September 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Premium automotive feel, sleek and modern, dark with metallic accents (var(--color-gray-800), var(--color-gray-300))',
  ...
  // 13. November 2025 - Completed
  {
    ...
    briefing: {
      ...
      styleNotes: 'Exciting and aspirational, destination imagery, brand blue (var(--color-accent)) with warm accents',
  ...
  // 16. In Progress - Due Dec 15
  {
    ...
    briefing: {
      ...
      styleNotes: 'Modern tech aesthetic, smooth animations, brand purple (var(--color-purple-600)), professional voiceover',
  ...
  // 17. In Review - Due Dec 12
  {
    ...
    briefing: {
      ...
      styleNotes: 'Secure and premium feel, dark theme default, accent green (var(--color-success)), clean data display',
  ...
  // 18. Urgent - Due Dec 11
  {
    ...
    briefing: {
      ...
      styleNotes: 'Corporate professional, clean layouts, brand navy (var(--color-info-dark)), data visualization focused',
  ...
  // 20. In Progress - Due Dec 23
  {
    ...
    briefing: {
      ...
      styleNotes: 'Motivating and energetic, sunrise colors (var(--priority-high), var(--color-warning)), transformation imagery, inclusive',
