...
import styles from './ClientReportsPage.module.css';
      ...
      <div className={styles.content}>
        <div className={styles.contentHeader}>
          <p className={styles.subtitle}>
            {unreadReports.length > 0
              ? `You have ${unreadReports.length} unread report${unreadReports.length > 1 ? 's' : ''}`
        ...
        {reports?.length === 0 ? (
          <div className={styles.empty}>
            <p className={styles.emptyTitle}>No reports available yet.</p>
